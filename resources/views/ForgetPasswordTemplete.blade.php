                                        ...
                                        <table cellspacing="0 " cellpadding="0 ">
                                            <tr>
                                                <td class="scalable-image " width="640 " align="center ">
                                                    <a href="https://trkar-v2.lacasacode.com "><img src="https://trkar-v2.lacasacode.com/assets/images/trkar_logo1.png " alt=" " style="display: block; border: 0; max-width: 100%; height: auto;
    " width="640 "></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                                ...
                                                                <table cellspacing="0 " cellpadding="0 ">
                                                                    <tr>
                                                                        <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 22px; color: #464646; " width="400 " align="left ">
                                                                            <a href="https://trkar-v2.lacasacode.com " style="text-decoration: none; color: #464646; ">Enjoy The Experience With Us</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                ...
                                                                <table cellspacing="0 " cellpadding="0 ">
                                                                    <tr>
                                                                        <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px; " align="left ">
                                                                            A password reset code has been sent at your request.
                                                                            If you do not send this request, ignore this message 
                                                                            The password change code is : <h1>{{$code}}</h1>
                                                                            
                                                                            
                                                                            <a href="https://trkar-v2.lacasacode.com " style="text-decoration: underline; color: #0c99d5; display: inline-block; "></a>
                                                                            <br><br>Thanks,<br>The Trkar account team
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
