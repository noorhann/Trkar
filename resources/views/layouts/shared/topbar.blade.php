        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="{{ request()->fullUrlWithQuery(['system_language' => 'en']) }}" class="dropdown-item">
                        <span class="align-middle">English</span>
                    </a>
                    <a href="{{ request()->fullUrlWithQuery(['system_language' => 'ar']) }}" class="dropdown-item">
        ...
        <div class="modal-content modal-filled bg-success">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <p class="mt-3 text-white">{{ __('operation accomplished successfully') }}.</p>
