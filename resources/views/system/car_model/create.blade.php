...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {!! Form::open([
            'route' => isset($result) ? ['admin.car-model.update', $result->id] : 'admin.car-model.store',
            'files' => true,
...
@section('script')
    ...
    <script type="text/javascript">
        function submitMainForm() {
            ...
            formSubmit(
                '{{ isset($result) ? route('admin.car-model.update', $result->id) : route('admin.car-model.store') }}',
