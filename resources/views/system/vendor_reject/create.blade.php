...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {!! Form::open([
            'route' => isset($result) ? ['admin.vendor-reject.update', $result->id] : 'admin.vendor-reject.store',
            'files' => true,
            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        <label>{{ __('Reject Status') }}</label>
                        {!! Form::select(
                            'reject_status_id',
                            App\Helpers\Helper::rejectStatusForSelect(),
                            isset($result) ? $result->reject_status_id : null,
                            [
                                'class' => 'select2 form-control',
                                'id' => 'reject_status_id-form-input',
                                'autocomplete' => 'off',
                            ],
                        ) !!}
