            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        ...
                        {!! Form::text('', isset($result) ? $result->username : null, [
                            'class' => 'form-control',
                    ...
                    <div class="form-group mb-3">
                        ...
                        {!! Form::text('', isset($result) ? $result->email : null, [
                            'class' => 'form-control',
                            'id' => 'email-form-input',
                            'autocomplete' => 'off',
                        ]) !!}
                    ...
                    <div class="form-group mb-3" style="display: none">
                        ...
                        {!! Form::number('longitude', isset($userAddresses) ? $userAddresses->longitude : null, [
                            'class' => 'form-control',
                    ...
                    <div class="form-group mb-3" style="display: none">
                        ...
                        {!! Form::number('latitude', isset($userAddresses) ? $userAddresses->latitude : null, [
