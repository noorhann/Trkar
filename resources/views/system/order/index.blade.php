        ...
        <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 convert-text">
                                ...
                                {!! Form::select('status', App\Helpers\Helper::orderStatusesForSelect(), null, [
                                    'class' => 'form-control',
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            {{-- @if (App\Helpers\Helper::adminCan('admin.product.create'))
                                <a href="{{ route('admin.product.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle mr-2"></i> {{ __('Add Product') }}</a>
                            @endif --}}
                        </div>
                        <div class="col-sm-8">
