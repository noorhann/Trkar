...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {!! Form::open([
            'route' => isset($result) ? ['admin.store-branch.update', $result->id] : 'admin.store-branch.store',
            'files' => true,
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        <label>{{ __('Branch Picked Address') }}</label><br>
                        {!! Form::text('branch_picked_address', isset($result) ? $result->branch_picked_address : null, [
                            'class' => 'form-control',
                            'id' => 'branch_picked_address-form-input',
                            'autocomplete' => 'off',
                            'disabled' => 'disabled'

                        ]) !!}
                        <div class="invalid-feedback" id="branch_picked_address-form-error"></div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        {!! Form::select(
                            'store_id',
                            App\Helpers\Helper::storeForSelect(),
