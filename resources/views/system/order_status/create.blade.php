...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {!! Form::open([
            'route' => isset($result) ? ['admin.order-status.update', $result->id] : 'admin.order-status.store',
            'files' => true,
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="color" id="color-form-input" name="color" value="#e66465">
