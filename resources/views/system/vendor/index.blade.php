        ...
        <div class="col-md-12 grid-margin stretch-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 convert-text">
                                        ...
                                        {!! Form::select('approved', [null => __('Select Status'),'1' => __('Active'), '2' => __('In-Active')], null, [
                                            'class' => 'form-control',
                                            'id' => 'status-form-input',
                                        ]) !!}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            {{-- @if (App\Helpers\Helper::adminCan('admin.vendor.create'))
                                <a href="{{ route('admin.vendor.create') }}" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle mr-2"></i> {{ __('Add Vendor') }}</a>
                            @endif --}}
                        </div>
                        <div class="col-sm-8">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function approvedBlock($routeName, $reload) {
