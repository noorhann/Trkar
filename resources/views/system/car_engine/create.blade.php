...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {!! Form::open([
            'route' => isset($result) ? ['admin.car-engine.update', $result->id] : 'admin.car-engine.store',
            'files' => true,
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function submitMainForm() {
            formSubmitCar(
                '{{ isset($result) ? route('admin.car-engine.update', $result->id) : route('admin.car-engine.store') }}',
