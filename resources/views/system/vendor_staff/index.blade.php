        ...
        <div class="col-md-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        {{-- <div class="col-sm-4">
                            <a href="{{ route('admin.vendor-staff.create') }}" class="btn btn-danger mb-2"><i
                                    class="mdi mdi-plus-circle mr-2"></i> {{ __('Add Vendor Staff') }}</a>
                        </div> --}}
                        <div class="col-sm-8">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function approvedVendorStaff($routeName, $reload) {
