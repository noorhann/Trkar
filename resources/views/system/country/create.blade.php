...
@section('content')
    ...
    <div class="container-fluid">
            ...
            {!! Form::open([
                'route' => isset($result) ? ['admin.country.update', $result->id] : 'admin.country.store',
                'files' => true,
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        <div class="form-group mb-3">
                            <label>{{ __('Country Code') }}</label><br>
                            {!! Form::number('country_code', isset($result) ? $result->country_code : null, [
                                'class' => 'form-control',
                                'id' => 'country_code-form-input',
                                'autocomplete' => 'off',
                            ]) !!}
                            <div class="invalid-feedback" id="country_code-form-error"></div>
                        </div>
                        <div class="form-group mb-3">
                            <label>{{ __('iso3') }}</label><br>
                            {!! Form::number('iso3', isset($result) ? $result->iso3 : null, [
                                'class' => 'form-control',
                                'id' => 'iso3-form-input',
                                'autocomplete' => 'off',
                            ]) !!}
                            <div class="invalid-feedback" id="iso3-form-error"></div>
                        </div>
                        <div class="form-group mb-3">
                            <label>{{ __('Num Code') }}</label><br>
                            {!! Form::number('numcode', isset($result) ? $result->numcode : null, [
                                'class' => 'form-control',
                                'id' => 'numcode-form-input',
                                'autocomplete' => 'off',
                            ]) !!}
                            <div class="invalid-feedback" id="numcode-form-error"></div>
                        </div>
                        <div class="form-group mb-3">
                            <label>{{ __('Phone Code') }}</label><br>
                            {!! Form::number('phonecode', isset($result) ? $result->phonecode : null, [
                                'class' => 'form-control',
                                'id' => 'phonecode-form-input',
                                'autocomplete' => 'off',
                            ]) !!}
                            <div class="invalid-feedback" id="phonecode-form-error"></div>
                        </div>
